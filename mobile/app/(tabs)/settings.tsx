      ...
      >
        ...
        <SettingItem
          onPress={async () => {
            ...
            Alert.alert(
              APP_NAME,
              "Are you sure you want to reset Nephro Scan?",
              [
                {
                  text: "YES",
                  style: "default",
      ...
      >
        <SettingItem
          onPress={async () => {
            ...
            await Share.share(
              {
                url: "https://github.com/CrispenGari/NephroScan",
                message:
                  "An AI-powered mobile tool that assists in the detection of kidney stones from medical images, supporting early diagnosis and better treatment planning.: Download at https://github.com/CrispenGari/NephroScan",
                title: "Share  Nephro Scan with a Friend",
              },
              { dialogTitle: "Share Nephro Scan", tintColor: COLORS.tertiary }
            );
          }}
          title="Share Nephro Scan"
          Icon={
        ...
        <SettingItem
          ...
          title="How does Nephro Scan works"
        ...
        <SettingItem
          onPress={async () => {
            ...
            const res = await Linking.canOpenURL(
              "https://github.com/CrispenGari/NephroScan/issues"
            );
            if (res) {
              Linking.openURL(
                "https://github.com/CrispenGari/NephroScan/issues"
